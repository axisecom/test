<?php
    ...
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIPLBBTDWX4FIVO3A');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'AxisEcom Reports');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A3LUPB3C4YWG3I');
    ...
    ***********************************************************************/   
    //set_include_path(get_include_path() . PATH_SEPARATOR . '../inc/MarketplaceWebService/');    
